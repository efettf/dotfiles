inputs: {
  ...
  dwl = pkgs.dwl.overrideAttrs (old: {
    ...
    configFile = pkgs.writeText "config.def.h" ''
      ...
      static const float rootcolor[]             = COLOR(0x${lib.strings.removePrefix "#" config.scheme.base00}ff);
      static const float bordercolor[]           = COLOR(0x${lib.strings.removePrefix "#" config.scheme.base02}ff);
      static const float focuscolor[]            = COLOR(0x${lib.strings.removePrefix "#" config.scheme.base04}ff);
      static const float urgentcolor[]           = COLOR(0x${lib.strings.removePrefix "#" config.scheme.base08}ff);
